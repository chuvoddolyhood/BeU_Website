...
(23, 35, 1, 3, 3290000, 0, 9870000),
(24, 35, 3, 4, 5310500, 5, 21242000),
(25, 36, 1, 2, 3290000, 0, 6580000),
(26, 36, 3, 1, 5310500, 5, 5310500),
(27, 37, 2, 1, 4490000, 0, 4490000),
(28, 38, 1, 3, 3290000, 0, 9870000),
(29, 38, 2, 1, 4490000, 0, 4490000),
(30, 39, 2, 1, 4490000, 0, 4490000),
(31, 40, 2, 1, 4490000, 0, 4490000),
(32, 41, 4, 2, 9690000, 0, 19380000);
...
(5, 12, 52, 4990000, 259480000, 'ACER', '22-04-2022 17:18:52', 5);
...
(35, 'ThanhDepTraiVaiLon', 5, 0, '17/2/2022', '28/2/2022', 1, 'Hồ Chí Minh', 1),
(36, 'ThanhDepTraiVaiLon', 0, 0, '17/2/2022', '28/2/2022', 4, 'Hồ Chí Minh', 1),
(37, 'ThanhDepTraiVaiLon', 0, 4520000, '17/2/2022', '28/2/2022', 4, 'Hồ Chí Minh', 1),
(38, 'ThanhDepTraiVaiLon', 0, 10800000, '17/2/2022', '28/2/2022', 4, 'Hồ Chí Minh', 1),
(39, 'Quoc', 0, 4520000, '22/4/2022', '3/5/2022', 4, 'Hồ Chí Minh', 1),
(40, 'Quoc', 0, 4520000, '22/4/2022', '3/5/2022', 4, 'Bank: Nguyễn Đình Thanh|123456|Techcombank Hồ Chí Minh', 2),
(41, 'Quoc', 0, 17472000, '22/4/2022', '3/5/2022', 4, 'Hồ Chí Minh', 1);
...
(41, 'ThanhDepTraiVaiLon', 2, 'MSI MAG B560M MORTAR WIFI', 4490000, 1, 'Mainboard B560M'),
(46, 'Bun', 2, 'MSI MAG B560M MORTAR WIFI', 4490000, 1, 'Mainboard B560M');
...
(12, 'Màn hình ACER VG270 27\" IPS 75Hz FreeSync chuyên game', 'món', 4990000, 5300000, 52, 9, 10, 'Màn hình 27\"', 'ACER', 'Mỹ', 'Mới', 'Đang cập nhật', 'Công nghệ AMD FreeSync tối ưu hình ảnh. Công nghệ Visual Response Boost (VRB) chơi game liền mạch');
...
(26, 'ChucCo', 'CoTramXinhDep', 'Chúc cô ngày mới tốt lành', NULL, 999999999, NULL, 'thanhb1805813@student.ctu.edu.vn', '2021-11-27', 'Nữ', 0, 0, ''),
(27, 'NguyenDinhThanh', '', 'Nguyen Thanh', NULL, 2712, NULL, 'qsczsemko@gmail.com', '', '', 0, 0, '105790192457968582917'),
(28, 'ThanhDepTraiVaiLon', '', 'Thanh Nguyễn Đình', NULL, 773, NULL, 'nguyendinhthanh27120@gmail.com', '', '', 0, 0, '117058110663681559529'),
(29, 'ThanhB1805813', '', 'Nguyen Dinh Thanh B1805813', NULL, 123456, NULL, 'thanhb1805813@student.ctu.edu.vn', '', '', 0, 0, '104932889731705686372');
...
(37, 1, '123abc'),
(38, 1, 'led RGB'),
(39, 1, 'AsUs TuF gAmInG b460M-PrO'),
(40, 1, 'B460'),
(41, 1, 'MainBoard'),
(42, 1, 'MainBoard'),
(43, 1, 'MainBoard'),
...
(4, 'ChucCo', 'CoTramXinhDep', 'Võ Huỳnh Trâm', 1, 'Cần Thơ', 999999999),
...
--
ALTER TABLE `chitietdathang`
  MODIFY `MaChiTiet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `chitietnhaphang`
--
ALTER TABLE `chitietnhaphang`
  MODIFY `SoDonNhapHang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `dathang`
--
ALTER TABLE `dathang`
  MODIFY `SoDonDH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `giohang`
  MODIFY `MaGio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `hinhhanghoa`
  MODIFY `MaHinh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `khachhang`
--
ALTER TABLE `khachhang`
  MODIFY `MSKH` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `lichsutimkiem`
--
ALTER TABLE `lichsutimkiem`
  MODIFY `MaLichSu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
